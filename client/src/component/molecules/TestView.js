  ...
  return (
    ...
    >
      <Box w="100%" h="50%" borderRadius="12px">
        ...
        >
          <Box w="50%" h="100%">
            <Text fontSize="20px" color="rgb(135, 129, 153)">
              Title:{" "}
              {test?.title
                ? test?.title.charAt(0).toUpperCase() + test?.title.slice(1)
                : "Test"}
            </Text>
            <Text fontSize="15px" color="rgb(135, 129, 153)">
              Subject:{" "}
              {test?.testCategory
                ? test?.testCategory.charAt(0).toUpperCase() +
                  test?.testCategory.slice(1)
                : "Subject"}
            </Text>
            <Box mt="2%">
        ...
        <Box display="flex" alignItems="center" gap="20px">
          ...
          {test?.remaingMarksQuestionsTobeAdded === 0 ? (
            <Box ml="auto" cursor="pointer">
              <Tooltip label="View or Take test">
              <OpenInNewIcon
            ...
            <Tooltip label="Avaliable Soon">
              <Text ml="auto" fontSize="20px" color="gray">
              Avaliable Soon
            </Text>
            </Tooltip>
